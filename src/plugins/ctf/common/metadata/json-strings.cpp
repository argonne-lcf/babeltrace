...
const char * const logLevel = "log-level";
const char * const logLevelAlert = "alert";
const char * const logLevelCritical = "critical";
const char * const logLevelDebugFunction = "debug:function";
const char * const logLevelDebugLine = "debug:line";
const char * const logLevelDebugModule = "debug:module";
const char * const logLevelDebug = "debug";
const char * const logLevelDebugProcess = "debug:process";
const char * const logLevelDebugProgram = "debug:program";
const char * const logLevelDebugSystem = "debug:system";
const char * const logLevelDebugUnit = "debug:unit";
const char * const logLevelEmergency = "emergency";
const char * const logLevelError = "error";
const char * const logLevelInfo = "info";
const char * const logLevelNotice = "notice";
const char * const logLevelWarning = "warning";
