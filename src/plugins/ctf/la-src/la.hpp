...
{
    HeapComparator(const bt2c::Logger& loggerParam,
...
struct ctf_la_msg_iter_data
{
    ...
    explicit ctf_la_msg_iter_data(bt_self_message_iterator *selfMsgIter) :
        ...
        heap {HeapComparator {logger,bt2::SelfMessageIterator {self_msg_iter}.component().graphMipVersion()}}
    {
    }
...
ctf_la_get_supported_mip_versions(bt_self_component_class_source *selfCompClsSrc,
                                  const bt_value *params, void *data,
